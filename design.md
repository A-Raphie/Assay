...
- **Typography / Density / Motion:** convention. BinanceNova is theirs; we ship Geist Sans + Geist Mono (close kin, self-hosted, no FOUT) at their sizes. Dense where data, generous around the verdict. Motion amendment (Sep 4 audit, deliberate): stamp strike + landing tagline word-reveal + section fade-ups, all on the shared 700ms cubic-bezier(0.32,0.72,0,1); stillness everywhere else.
